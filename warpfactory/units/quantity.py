class Quantity:
    ...
    def _parse_unit(self, unit: str) -> None:
        ...
        if "/" in unit:
            ...
            self._UNIT_FACTORS[unit] = (
                self._UNIT_FACTORS[num] / self._UNIT_FACTORS[denom]
            )
        else:
    ...
    def __add__(self, other: "Quantity") -> "Quantity":
        ...
        if not self._is_compatible(other.unit):
            raise ValueError(
                f"Cannot add quantities with units {self.unit} and {other.unit}"
            )

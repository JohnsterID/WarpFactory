...
def main():
    ...
    print(f"Alcubierre v={V}c R={R} m sigma={SIGMA} 1/m "
          f"on {N}^3 grid at {SPACING} m")
    print(f"peak Eulerian energy density: {rho_si.min():.3e} J/m^3 "
    ...
    weak_map = get_energy_conditions(stress_energy, metric, "Weak",
                                     num_angular_vec=50, num_time_vec=8)
